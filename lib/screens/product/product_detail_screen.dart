...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
  ...
  void _loadProductAndFavoriteStatus() async {
    ...
    if (widget.product != null) {
      ...
      _loadedProduct = productProvider.selectedProduct;
      _currentImageUrl = _loadedProduct!.imageUrl;
      _isFavorite = _loadedProduct!.isFavorite;
    }
    ...
    if (_userId != null && _loadedProduct != null && mounted) {
      ...
      if (mounted) {
        setState(() {
          _isFavorite = productProvider.favoriteProducts.any((p) => p.id == _loadedProduct!.id);
  ...
  void _toggleFavorite() async {
    ...
    final productProvider = Provider.of<ProductProvider>(context, listen: false);
    try {
      await productProvider.toggleFavorite(_userId!, _loadedProduct!.id, !_isFavorite);
      if (mounted) {
        setState(() {
